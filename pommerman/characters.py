"""These are objects in the game world. Please do not edit existing classes in file."""
...
class Searcher(object):
    """Container to keep the search agent state."""

    def __init__(self, agent_id=None, game_type=None):
        self.game_type = constants.GameType.Search
        self.ammo = 0
        self.is_alive = True
        self.blast_strength = 0  # set to 0 as Agent does not have bombs
        self.can_kick = False  # set to False as there are no bombs in search env
    ...
    def incr_ammo(self):
        # increases ammo to a max of 1,
        # which will be used to determine item has been picked up and agent reached goal
        self.ammo = min(self.ammo + 1, 1)
